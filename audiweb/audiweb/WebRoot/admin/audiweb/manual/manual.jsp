...
(function(){
	Ext.define('mainModel',{
		...
		fields : ['cmName','cmGender','cmMobile','cmBirthday','cmAddtime','cmProvince','cmCity','cmAddress','cmZip','cmIscar','cmBrand','cmModel','cmFootnum']
	});
	/**store*/
	var mainModel_store = Ext.create('Ext.data.Store',{
		...
		proxy:{
			type:'ajax',
			url:'manual_getList.action',//请求后台西信息
			method:'POST',
			reader:{
				type:'json',
				root:'list', // 根节点
	...
	function mainGrid(){
		return Ext.create('Ext.grid.Panel',{
			...
			tbar:[
				{text:"导出申请手册用户数据",iconCls: 'icon-down',handler:function(){
						...
						Ext.Ajax.request( {
							type : 'ajax',
							timeout : 60000,
							url : 'manual_driverExport.action',
							method : 'POST',
							params : { 
							...
							success : function(response, opts) {
								...
								if(retData.fileName){
									...
									downloadIframe.src ="manual_downloadExcel.action?fileName="+retData.fileName;
