 ...
 <%a++; %>
	...
	//alert(listjxs[1]);
		var opts = { 
         ...
         //html += " <span style=\"width:65px; word-spacing:19px; display:inline-block;\">Address： </span><span style="+"word-break:break-all;word-wrap:break-word;"+">" + listjxs[2] + " </span><br/>"; 
         html += " <span style=\" display:inline-block;\">Address： </span>" + listjxs[2] + " </span><br/>"; 
         ...
         html += "<a   href='javascript:aaa("+i+");' style=\"padding-right: 10px;\"> <span style=\"font-family:'宋体'; font-weight:bold;color:#cc0033;margin-right:1px\">></span> For Detailed Information  </a> ";        
         html += "</p></div></div>";
      ...
      var icon = new BMap.Icon("baidu_ico/baidu_icon"+(parseInt(index)+1)+".png", new BMap.Size(26, 26));
       var opts = { 
        ...
        // 信息窗口标题
         ...
         html += "<a   href='javascript:aaa("+this.infomation[index].did+");' style=\"padding-right: 10px;\"> <span style=\" font-weight:bold;color:#cc0033;margin-right:1px\">></span> For Detailed Information </a>";       
         html += "</p></div></div>";
         var infoWindow = new BMap.InfoWindow(html, opts);
          // 创建信息窗口对象 
