...
public final class EmailUtilAudiWeb {
	...
	private static final String action = "user_activateUser.action";
	...
	public static boolean sendEmail(String email, HttpServletRequest req, String flag, String username) {
		try {
			String subject = EmailUtilAudiWeb.getSubject();
			String activateUrl = getActivateUrl(email, req, flag);
			
			// 得到邮件内容
			String body = EmailUtilAudiWeb.getBody(email, activateUrl, flag, username);
	...
	public static String getBody(String email, String url, String flag, String username) throws Exception {
		Date date = new Date();
		String body = "<table width=\"643\" border=\"0\" align=\"center\"  cellspacing=\"0\" cellpadding=\"0\">"+
		 ...
		 username+
		 "阁下:</p>"+
		 "     <p style=\"font:14px/1.8em '宋体',Helvetica,sans-serif'\">"+
		 "     	感谢您申请成为一汽-大众奥迪官方网站注册用户！<br />您的登录账号："+
		 "     	<span style=\"font-family:'Helvetica';\">" +
		 email+
		 "</span>"+
		 "     </p>"+
		 "	<p style=\"font:14px/1.8em '宋体',Helvetica,sans-serif;padding:18px 0 0;\">请点击以下链接完成注册验证，尽享奥迪为您提供的尊崇服务。</p>"+
		 "     <p>"+
		 "     <a href=\"" +
		 url+
		 "\" style=\"color:#cc0033;font:14px/1.8em 'Verdana';\" target=\"_blank\">" +
		 url+
		 " </a></p>"+
		 "    <p style=\"font:12px/1.4em '宋体',Helvetica,sans-serif;padding:0 0 18px;\">（如果链接无法正常打开，请复制到浏览器地址栏中）</p>"+
		 "     <p style=\"font:14px/1.8em '宋体',Helvetica,sans-serif;padding:0 0 40px;\">此邮件为系统自动发出，请勿直接回复。<br />"+
		 "     如您并未在一汽-大众奥迪官方网站注册，"+
