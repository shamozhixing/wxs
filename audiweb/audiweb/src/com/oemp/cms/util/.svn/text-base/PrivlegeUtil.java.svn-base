 ...
 *
 */
public final class PrivlegeUtil {
	...
	/** 是否启用操作权限 */
	public final static boolean SYSTEM_PRIVEGE = new Boolean(ApplicationResources.getText("system.privlege")).booleanValue();
	
	@SuppressWarnings("unchecked")
	private static Map<Integer,String> getPrivlege(){
		return (Map<Integer,String>)CmsSession.getInstance().get(CmsConstants.USER_PRIVLEGE_MENU);
	}
	/** 
	 * 权限判断
	 * @param nodeid	功能ID
	...
	public static boolean isAdmins(){
		...
		return !SYSTEM_PRIVEGE || (cu.getCmuIsAdmin()!=null && cu.getCmuIsAdmin()==1);
	}
